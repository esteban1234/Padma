...
<body>
  ...
  <nav class="pull-left">
    <ul>
      ...
      <a class="enlaces" id="select" href="servicios.php">SERVICIOS</a>
       ...
       <h1 style="margin-top: 7%; margin-bottom: 7%;" class="text-center eleccion-padma2">Supervisión de construcción de obras para petróleo y gas</h1>
        <div class="row">
          <div class="col-md-3">
            ...
            <h4 class="text-center">Construcción de gasoductos y ramales de alimentación.</h4>
          </div>
          <div class="col-md-3">
            <div style="text-align: center;">
            	<i class="fa fa-fire fa-5x" aria-hidden="true"></i>
            </div> <br><br>
            <h4 class="text-center">Construcción de oleoductos y cañerías para inyección.</h4>
          </div>
          <div class="col-md-3">
            <div style="text-align: center;">
            	<i class="fa fa-fire fa-5x" aria-hidden="true"></i>
            </div> <br><br>
            <h4 class="text-center">Plantas reguladoras de presión, puentes de medición y trampas de scrapers.</h4>
          </div>
          <div class="col-md-3">
            <div style="text-align: center;">
            	<i class="fa fa-fire fa-5x" aria-hidden="true"></i>
            </div> <br><br>
            <h4 class="text-center">Instalaciones industriales de gas.</h4>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            ...
            <h4 class="text-center">Redes de incendio.</h4>
          </div>
          <div class="col-md-4">
            <div style="text-align: center;">
            	<i class="fa fa-fire fa-5x" aria-hidden="true"></i>
            </div> <br><br>
            <h4 class="text-center">Remediamiento de suelos contaminados.</h4>
          </div>
          <div class="col-md-4">
            <div style="text-align: center;">
            	<i class="fa fa-fire fa-5x" aria-hidden="true"></i>
            </div> <br><br>
            <h4 class="text-center">Reparación de ductos, parcheos y clock spring.</h4>
          </div>
        </div>
      </div>
    </div>

...
<article class="buscando">
  <h1>¿Que andas buscando?</h1>
  <div class="container">
        <div class="row new-style-col">
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/hidra.png" class="img-responsive">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/tren.png" class="img-responsive">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/motor.png" class="img-responsive img-rounded">
            <h2 class="">Motores</h2>
          ...
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/corte.png" class="img-responsive">
            <h2 class="">Corte</h2>
...
<article class="buscando2">
  ...
  <div class="container">
        <div class="row new-style-col">
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/CHANGLIN-ZL18H.png" class="img-responsive image">
            <h4 class="">CARGADOR FRONTAL ZL18H</h4>

          </div>
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/rodillo-changlin.png" class="img-responsive image">
            <h4 class="">RODILLO AUTOPROPULSADO YZ12-HD</h4>

          </div>
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/motoniveladora.png" class="img-responsive  image">
            <h4 class="">MOTONIVELADORA PY190H</h4>

          </div>
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/retroexcavadora.png" class="img-responsive image">
        ...
        <div class="row new-style-col">
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/cargador-frontal-937H.png" class="img-responsive image">
            <h4 class="">CARGADOR FRONTAL 937H</h4>

          </div>
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/cargador.png" class="img-responsive image">
            <h4 class="">CARGADOR FRONTAL 957H</h4>

          </div>
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/minicargador.png" class="img-responsive image">
            <h4 class="">MINI CARGADOR FRONTAL 275</h4>

          </div>
          <div class="col-xs-12 col-sm-3 col-md-3">
            <img src="img/excavadora.png" class="img-responsive image">
